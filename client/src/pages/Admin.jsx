          ...
          {activeTab === 'overview' && (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 18, marginBottom: 20 }}>
                {/* Left Card: Royal Indigo Gradient Welcome Banner */}
                <div
                ...
                >
                  <span style={{ fontSize: '.78rem', opacity: 0.85, textTransform: 'uppercase', letterSpacing: '.08em', fontWeight: 700 }}>
                    Date range: last 30 days
                  </span>
                  <h2 style={{ fontSize: '1.7rem', margin: '6px 0 8px', fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800 }}>
                    Welcome back <br />
                    {adminProfileState.fullName}!
                  </h2>
                  <p style={{ margin: 0, fontSize: '.9rem', opacity: 0.95, lineHeight: 1.4 }}>
                    You've solved <b style={{ textDecoration: 'underline' }}>80% of resort operations & guest inquiries</b> this month!
